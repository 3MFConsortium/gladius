...
namespace gladius::ui
{
     ...
     * @brief Shows 3MF files in a given directory with their thumbnails
     */
    class ThreemfFileViewer
    {
    public:
        ...
        /**
         * @brief Show or hide the viewer
         * @param visible Whether the viewer should be visible
         */
        void setVisibility(bool visible);

        /**
         * @brief Check if the viewer is visible
         * @return Whether the viewer is visible
         */
        [[nodiscard]] bool isVisible() const { return m_visible; }

        /**
         * @brief Render the 3MF file viewer UI
    ...
    private:
        ...
        bool m_visible = false;                                      ///< Whether the viewer is visible

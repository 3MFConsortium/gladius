...
typedef GladiusLibResult (*PGladiusLibChannelAccessor_GetMetaInfoPtr)(
  GladiusLib_ChannelAccessor pChannelAccessor,
  GladiusLib::sChannelMetaInfo * pMetaInfo);

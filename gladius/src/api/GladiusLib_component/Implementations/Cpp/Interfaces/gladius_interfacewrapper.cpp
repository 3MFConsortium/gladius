...
development of GladiusLib. The functions in this file need to be implemented. It needs to be
generated only once.
...
GladiusLibResult handleGladiusLibException(IBase * pIBaseClass,
                                           EGladiusLibInterfaceException & Exception)
{
...
**************************************************************************************************************************/
GladiusLibResult gladiuslib_boundingbox_getmin(GladiusLib_BoundingBox pBoundingBox,
...
GladiusLibResult gladiuslib_boundingbox_getmax(GladiusLib_BoundingBox pBoundingBox,
...
**************************************************************************************************************************/
GladiusLibResult
gladiuslib_detailederroraccessor_getsize(GladiusLib_DetailedErrorAccessor pDetailedErrorAccessor,
                                         GladiusLib_uint64 * pSize)
{
    ...
    try
    {
        if (pSize == nullptr)
            throw EGladiusLibInterfaceException(GLADIUSLIB_ERROR_INVALIDPARAM);
        IDetailedErrorAccessor * pIDetailedErrorAccessor =
          dynamic_cast<IDetailedErrorAccessor *>(pIBaseClass);
...
GladiusLibResult
gladiuslib_detailederroraccessor_next(GladiusLib_DetailedErrorAccessor pDetailedErrorAccessor,
                                      bool * pResult)
{
    IBase * pIBaseClass = (IBase *) pDetailedErrorAccessor;
...
GladiusLibResult
gladiuslib_detailederroraccessor_prev(GladiusLib_DetailedErrorAccessor pDetailedErrorAccessor,
                                      bool * pResult)
{
    IBase * pIBaseClass = (IBase *) pDetailedErrorAccessor;
...
GladiusLibResult
gladiuslib_detailederroraccessor_begin(GladiusLib_DetailedErrorAccessor pDetailedErrorAccessor)
{
    IBase * pIBaseClass = (IBase *) pDetailedErrorAccessor;
...
GladiusLibResult
gladiuslib_detailederroraccessor_gettitle(GladiusLib_DetailedErrorAccessor pDetailedErrorAccessor,
...
GladiusLibResult gladiuslib_detailederroraccessor_getdescription(
...
GladiusLibResult gladiuslib_detailederroraccessor_getseverity(
  GladiusLib_DetailedErrorAccessor pDetailedErrorAccessor,
...
**************************************************************************************************************************/
GladiusLibResult gladiuslib_resourceaccessor_getsize(GladiusLib_ResourceAccessor pResourceAccessor,
                                                     GladiusLib_uint64 * pSize)
{
...
GladiusLibResult gladiuslib_resourceaccessor_next(GladiusLib_ResourceAccessor pResourceAccessor,
                                                  bool * pResult)
{
    IBase * pIBaseClass = (IBase *) pResourceAccessor;
...
GladiusLibResult gladiuslib_resourceaccessor_prev(GladiusLib_ResourceAccessor pResourceAccessor,
                                                  bool * pResult)
{
    IBase * pIBaseClass = (IBase *) pResourceAccessor;
...
**************************************************************************************************************************/
GladiusLibResult
gladiuslib_polygonaccessor_getcurrentvertex(GladiusLib_PolygonAccessor pPolygonAccessor,
...
GladiusLibResult gladiuslib_polygonaccessor_getarea(GladiusLib_PolygonAccessor pPolygonAccessor,
...
**************************************************************************************************************************/
GladiusLibResult
gladiuslib_contouraccessor_getcurrentpolygon(GladiusLib_ContourAccessor pContourAccessor,
...
**************************************************************************************************************************/
GladiusLibResult gladiuslib_faceaccessor_getcurrentface(GladiusLib_FaceAccessor pFaceAccessor,
...
**************************************************************************************************************************/
GladiusLibResult gladiuslib_channelaccessor_evaluate(GladiusLib_ChannelAccessor pChannelAccessor,
...
GladiusLibResult gladiuslib_channelaccessor_getmetainfo(GladiusLib_ChannelAccessor pChannelAccessor,
...
GladiusLibResult gladiuslib_channelaccessor_copy(GladiusLib_ChannelAccessor pChannelAccessor,
...
GladiusLibResult gladiuslib_channelaccessor_getname(GladiusLib_ChannelAccessor pChannelAccessor,
...
GladiusLibResult
gladiuslib_channelaccessor_switchtochannel(GladiusLib_ChannelAccessor pChannelAccessor,
                                           const char * pName,
                                           bool * pResult)
{
    IBase * pIBaseClass = (IBase *) pChannelAccessor;
...
**************************************************************************************************************************/
GladiusLibResult gladiuslib_gladius_loadassembly(GladiusLib_Gladius pGladius,
...
GladiusLibResult gladiuslib_gladius_getfloatparameter(GladiusLib_Gladius pGladius,
...
GladiusLibResult gladiuslib_gladius_setfloatparameter(GladiusLib_Gladius pGladius,
                                                      const char * pModelName,
                                                      const char * pNodeName,
                                                      const char * pParameterName,
...
GladiusLibResult gladiuslib_gladius_getstringparameter(GladiusLib_Gladius pGladius,
                                                       const char * pModelName,
                                                       const char * pNodeName,
                                                       const char * pParameterName,
...
GladiusLibResult gladiuslib_gladius_setstringparameter(GladiusLib_Gladius pGladius,
                                                       const char * pModelName,
                                                       const char * pNodeName,
                                                       const char * pParameterName,
                                                       const char * pValue)
...
GladiusLibResult gladiuslib_gladius_getvector3fparameter(GladiusLib_Gladius pGladius,
                                                         const char * pModelName,
                                                         const char * pNodeName,
                                                         const char * pParameterName,
...
GladiusLibResult gladiuslib_gladius_setvector3fparameter(GladiusLib_Gladius pGladius,
                                                         const char * pModelName,
                                                         const char * pNodeName,
                                                         const char * pParameterName,
...
GladiusLibResult gladiuslib_gladius_generatecontour(GladiusLib_Gladius pGladius,
                                                    GladiusLib_single fZ,
...
GladiusLibResult gladiuslib_gladius_computeboundingbox(GladiusLib_Gladius pGladius,
...
GladiusLibResult gladiuslib_gladius_generatepreviewmesh(GladiusLib_Gladius pGladius,
...
GladiusLibResult gladiuslib_gladius_getchannels(GladiusLib_Gladius pGladius,
...
GladiusLibResult
gladiuslib_gladius_getdetailederroraccessor(GladiusLib_Gladius pGladius,
...
GladiusLibResult gladiuslib_gladius_injectsmoothingkernel(GladiusLib_Gladius pGladius,
                                                          const char * pKernel)
{
    IBase * pIBaseClass = (IBase *) pGladius;
...
GladiusLibResult _gladiuslib_getprocaddress_internal(const char * pProcName, void ** ppProcAddress)
{
    ...
    if (!sbProcAddressMapHasBeenInitialized)
    {
        ...
        sProcAddressMap["gladiuslib_detailederroraccessor_getsize"] =
          (void *) &gladiuslib_detailederroraccessor_getsize;
        sProcAddressMap["gladiuslib_detailederroraccessor_next"] =
          (void *) &gladiuslib_detailederroraccessor_next;
        sProcAddressMap["gladiuslib_detailederroraccessor_prev"] =
          (void *) &gladiuslib_detailederroraccessor_prev;
        sProcAddressMap["gladiuslib_detailederroraccessor_begin"] =
          (void *) &gladiuslib_detailederroraccessor_begin;
        sProcAddressMap["gladiuslib_detailederroraccessor_gettitle"] =
          (void *) &gladiuslib_detailederroraccessor_gettitle;
        sProcAddressMap["gladiuslib_detailederroraccessor_getdescription"] =
          (void *) &gladiuslib_detailederroraccessor_getdescription;
        sProcAddressMap["gladiuslib_detailederroraccessor_getseverity"] =
          (void *) &gladiuslib_detailederroraccessor_getseverity;
        sProcAddressMap["gladiuslib_resourceaccessor_getsize"] =
          (void *) &gladiuslib_resourceaccessor_getsize;
        sProcAddressMap["gladiuslib_resourceaccessor_next"] =
          (void *) &gladiuslib_resourceaccessor_next;
        sProcAddressMap["gladiuslib_resourceaccessor_prev"] =
          (void *) &gladiuslib_resourceaccessor_prev;
        sProcAddressMap["gladiuslib_resourceaccessor_begin"] =
          (void *) &gladiuslib_resourceaccessor_begin;
        sProcAddressMap["gladiuslib_polygonaccessor_getcurrentvertex"] =
          (void *) &gladiuslib_polygonaccessor_getcurrentvertex;
        sProcAddressMap["gladiuslib_polygonaccessor_getarea"] =
          (void *) &gladiuslib_polygonaccessor_getarea;
        sProcAddressMap["gladiuslib_contouraccessor_getcurrentpolygon"] =
          (void *) &gladiuslib_contouraccessor_getcurrentpolygon;
        sProcAddressMap["gladiuslib_faceaccessor_getcurrentface"] =
          (void *) &gladiuslib_faceaccessor_getcurrentface;
        sProcAddressMap["gladiuslib_channelaccessor_evaluate"] =
          (void *) &gladiuslib_channelaccessor_evaluate;
        sProcAddressMap["gladiuslib_channelaccessor_getmetainfo"] =
          (void *) &gladiuslib_channelaccessor_getmetainfo;
        sProcAddressMap["gladiuslib_channelaccessor_copy"] =
          (void *) &gladiuslib_channelaccessor_copy;
        sProcAddressMap["gladiuslib_channelaccessor_getname"] =
          (void *) &gladiuslib_channelaccessor_getname;
        sProcAddressMap["gladiuslib_channelaccessor_switchtochannel"] =
          (void *) &gladiuslib_channelaccessor_switchtochannel;
        sProcAddressMap["gladiuslib_gladius_loadassembly"] =
          (void *) &gladiuslib_gladius_loadassembly;
        sProcAddressMap["gladiuslib_gladius_exportstl"] = (void *) &gladiuslib_gladius_exportstl;
        sProcAddressMap["gladiuslib_gladius_getfloatparameter"] =
          (void *) &gladiuslib_gladius_getfloatparameter;
        sProcAddressMap["gladiuslib_gladius_setfloatparameter"] =
          (void *) &gladiuslib_gladius_setfloatparameter;
        sProcAddressMap["gladiuslib_gladius_getstringparameter"] =
          (void *) &gladiuslib_gladius_getstringparameter;
        sProcAddressMap["gladiuslib_gladius_setstringparameter"] =
          (void *) &gladiuslib_gladius_setstringparameter;
        sProcAddressMap["gladiuslib_gladius_getvector3fparameter"] =
          (void *) &gladiuslib_gladius_getvector3fparameter;
        sProcAddressMap["gladiuslib_gladius_setvector3fparameter"] =
          (void *) &gladiuslib_gladius_setvector3fparameter;
        sProcAddressMap["gladiuslib_gladius_generatecontour"] =
          (void *) &gladiuslib_gladius_generatecontour;
        sProcAddressMap["gladiuslib_gladius_computeboundingbox"] =
          (void *) &gladiuslib_gladius_computeboundingbox;
        sProcAddressMap["gladiuslib_gladius_generatepreviewmesh"] =
          (void *) &gladiuslib_gladius_generatepreviewmesh;
        sProcAddressMap["gladiuslib_gladius_getchannels"] =
          (void *) &gladiuslib_gladius_getchannels;
        sProcAddressMap["gladiuslib_gladius_getdetailederroraccessor"] =
          (void *) &gladiuslib_gladius_getdetailederroraccessor;
        sProcAddressMap["gladiuslib_gladius_cleardetailederrors"] =
          (void *) &gladiuslib_gladius_cleardetailederrors;
        sProcAddressMap["gladiuslib_gladius_injectsmoothingkernel"] =
          (void *) &gladiuslib_gladius_injectsmoothingkernel;
...
**************************************************************************************************************************/
GladiusLibResult gladiuslib_getversion(GladiusLib_uint32 * pMajor,
...
GladiusLibResult gladiuslib_getlasterror(GladiusLib_Base pInstance,
